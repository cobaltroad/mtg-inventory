...
class CommanderScrapingIntegrationTest < ActiveJob::TestCase
  ...
  test "discovery job updates existing commander rank without changing last_scraped_at" do
    ...
    existing_commander = Commander.create!(
      name: "Commander 1",
      rank: 10,
      edhrec_url: "https://disambiguation.com/commanders/commander-1",
    ...
    mock_commanders = [
      { name: "Commander 1", rank: 1, url: "https://disambiguation.com/commanders/commander-1" }
    ]
  ...
  test "decklist job updates last_scraped_at when scraping" do
    commander = Commander.create!(
      name: "Test Commander",
      rank: 1,
      edhrec_url: "https://disambiguation.com/commanders/test",
      last_scraped_at: nil
    )
  ...
  test "failed decklist scrape doesn't prevent other jobs from running" do
    # Create 3 commanders
    commander1 = Commander.create!(name: "Commander 1", rank: 1, edhrec_url: "https://disambiguation.com/1")
    commander2 = Commander.create!(name: "Commander 2", rank: 2, edhrec_url: "https://disambiguation.com/2")
    commander3 = Commander.create!(name: "Commander 3", rank: 3, edhrec_url: "https://disambiguation.com/3")
    ...
    EdhrecScraper.define_singleton_method(:fetch_commander_decklist) do |url|
      call_count += 1
      if url.include?("disambiguation.com/2")
